...
if os.path.isfile(__file__):
    ...
    if getpass.getuser() == 'bugger':
        dest_path = '/home/bugger/PycharmProjects/pytorch_in_mri/objective/noise_test'
    else:
        dest_path = '/home/seb/code/pytorch_in_mri/objective/noise_test'
...
target_name = "noise_test.json"  # ==>


template = {"name": "Noise test",
            "packed_keys": [
                            ],
