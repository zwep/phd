...
import objective.noise_test.executor_noise_test as executor  # ==>
import objective.recall_base as recall_base
config_file_name = "noise_test.json"  # ==>>

import logging
import logging.config
import logging_tree

# Load the logging stuff...
...
if __name__ == '__main__':
    ...
    config_file = "/home/bugger/PycharmProjects/pytorch_in_mri/objective/noise_test/configuration/noise_test.json" #==>
    ...
    config_model['dir']['ddata'] = "/media/bugger/MyBook/data/celeba"
    ...
    main_logger.info(f'Amount of configs created {len(model_path_list)}')
    for full_model_path in model_path_list:
        main_logger.info(f'Chosen config: {full_model_path}')
        ...
        decision_obj = executor.DecisionMakerNoise(model_path=full_model_path, debug=debug_ind, index_gpu=index_gpu)  # ==>>
