...
config_file_name = "prostate_weighting.json"  # ==>>
...
if __name__ == '__main__':
    ...
    while index_gpu == -1:
        print("Trying to find a good GPU")
        time.sleep(10)
        index_gpu, p_gpu = hnvidia.get_free_gpu_id(claim_memory=config_model['gpu_frac'])
    ...
    for full_model_path in model_path_list:
        ...
        decision_obj = executor.DecisionMakerProstateWeighting(model_path=full_model_path, debug=debug_ind, index_gpu=index_gpu)  # ==>>
