...
if os.path.isfile(__file__):
    ...
    if getpass.getuser() == 'bugger':
        dest_path = '/home/bugger/PycharmProjects/pytorch_in_mri/objective/rx2tx'
    else:
        dest_path = '/home/seb/code/pytorch_in_mri/objective/rx2tx'
...
template = {"name": "rxtx",
            ...
            "optimizer": {"name": "Adam",
                          "policy": "cyclic",  # Other option: "linear", "cyclic"
                          "policy_config": {"base_lr": 0.001, "max_lr": 0.0005,
