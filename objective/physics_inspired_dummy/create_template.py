...
if os.path.isfile(__file__):
    ...
    if getpass.getuser() == 'bugger':
        dest_path = '/home/bugger/PycharmProjects/pytorch_in_mri/objective/physics_inspired_dummy'
    else:
        dest_path = '/home/seb/code/pytorch_in_mri/objective/physics_inspired_dummy'
...
target_name = "physics_inspired_dummy.json"  # ==>


template = {"name": "physics_inspired_dummy",
            "packed_keys": [
                            ],
            "dir": {"ddata":  ""},
            "model": {"model_choice": "nlayernet",
                      ...
                      "n_epoch_save": None,
                       ...
                       "config": {"input_shape": (2, 200)}
                      },
            "optimizer": {"name": "Adam",
                          "policy": "",  # Other option: "linear", "cyclic"
                          "policy_config": {"base_lr": 0.01, "max_lr": 0.005,
                                            "step_size_up": 500},
                          "config": {"lr": 0.0001}},
