...
if os.path.isfile(__file__):
    ...
    if getpass.getuser() == 'bugger':
        dest_path = '/home/bugger/PycharmProjects/pytorch_in_mri/objective/mm_segment'
    else:
        dest_path = '/home/seb/code/pytorch_in_mri/objective/mm_segment'
...
target_name = "mm_segment.json"  # ==>


template = {"name": "mm_segment",
            "packed_keys": [
                            ],
            "dir": {"ddata":  "/media/bugger/MyBook/data/m&m/MnM_dataset"},
