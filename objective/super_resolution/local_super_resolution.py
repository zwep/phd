...
config_file_name = "super_resolution.json"  # ==>>
...
if __name__ == '__main__':
    ...
    config_file = "/home/bugger/PycharmProjects/pytorch_in_mri/objective/super_resolution/configuration/super_resolution.json"
    ...
    # config_model['dir']['ddata'] = "/media/bugger/Documents/data/celeba"
    ...
    main_logger.info('Amount of configs created ', len(model_path_list))
    for full_model_path in model_path_list:

        main_logger.info('Chosen config: ', full_model_path)
        ...
        decision_obj = executor.DecisionMakerSuperRes(model_path=full_model_path, debug=debug_ind, index_gpu=index_gpu)  # ==>>
