...
if os.path.isfile(__file__):
    ...
    if getpass.getuser() == 'bugger':
        dest_path = '/home/bugger/PycharmProjects/pytorch_in_mri/objective/super_resolution'
    else:
        dest_path = '/home/seb/code/pytorch_in_mri/objective/super_resolution'
...
target_name = "super_resolution.json"  # ==>


template = {"name": "super_resolution",
            "packed_keys": [],
            "dir": {"ddata":  "/media/bugger/MyBook/data/celeba"},
            "model": {"model_choice": "cyclegan",
