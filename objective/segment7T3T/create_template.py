...
if os.path.isfile(__file__):
    ...
    if getpass.getuser() == 'bugger':
        dest_path = '/home/bugger/PycharmProjects/pytorch_in_mri/objective/segment7T3T'
    else:
        dest_path = '/home/seb/code/pytorch_in_mri/objective/segment7T3T'
...
target_name = "segment7T3T.json"  # ==>


template = {"name": "segment7T3T",
            "packed_keys": [
                            ],
            "dir": {"ddata":  "/data/cmr7t3t/biasfield_sa_acdc"},
