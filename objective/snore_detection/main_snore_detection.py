...
import objective.snore_detection.executor_snore_detection as executor  # ==>
import objective.recall_base as recall_base
config_file_name = "snore_detection.json"  # ==>>
...
if __name__ == '__main__':
    ...
    for full_model_path in model_path_list:
        ...
        decision_obj = executor.DecisionMakerSnoreDetection(model_path=full_model_path, debug=debug_ind, index_gpu=index_gpu)  # ==>>
