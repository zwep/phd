...
if os.path.isfile(__file__):
    ...
    if getpass.getuser() == 'bugger':
        dest_path = '/home/bugger/PycharmProjects/pytorch_in_mri/objective/snore_detection'
    else:
        dest_path = '/home/seb/code/pytorch_in_mri/objective/snore_detection'
...
target_name = "snore_detection.json"  # ==>


template = {"name": "snore_detection",
            "packed_keys": [
                            ],
            "dir": {"ddata":  ""},
