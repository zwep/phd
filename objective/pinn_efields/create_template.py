...
if os.path.isfile(__file__):
    ...
    if getpass.getuser() == 'bugger':
        dest_path = '/home/bugger/PycharmProjects/pytorch_in_mri/objective/pinn_efields'
    else:
        dest_path = '/home/seb/code/pytorch_in_mri/objective/pinn_efields'
...
target_name = "pinn_efields.json"  # ==>


template = {"name": "pinn_efields",
            "packed_keys": [
                            ],
            "dir": {"ddata":  "/local_scratch/sharreve/mri_data/pinn_fdtd"},
            "model": {"model_choice": "regular",
                      "return_gradients": False,
                      "n_epoch": 500,
                      "n_epoch_save": 5,
                      "config": {"input_shape": (8, 256, 256)}
                      },
            "optimizer": {"name": "Adam",
