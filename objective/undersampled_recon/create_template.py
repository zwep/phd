...
if os.path.isfile(__file__):
    ...
    if getpass.getuser() == 'bugger':
        dest_path = '/home/bugger/PycharmProjects/pytorch_in_mri/objective/undersampled_recon'
    else:
        dest_path = '/home/seb/code/pytorch_in_mri/objective/undersampled_recon'
...
target_name = "undersampled_recon.json"  # ==>
# "/data/seb/unfolded_radial/cartesian_radial_dataset_4ch;/data/seb/unfolded_radial/cartesian_radial_dataset_p2ch;/data/seb/unfolded_radial/cartesian_radial_dataset_transverse"},


template = {"name": "undersampled recon experiment - fastmri data",
            "packed_keys": [],
            "dir": {"ddata": "/data/seb/radial_unprocessed/cartesian_cardiac_cine/split_data/4ch"},
            "model": {"model_choice": "regular",
                      "return_gradients": False,
                      },
            "optimizer": {"name": "Adam",
                          "policy": "",  # Other option: "linear", "cyclic"
                          "policy_config": {"base_lr": 0.001, "max_lr": 0.005,
                                            "step_size_up": 500},
                          "config": {"lr": 0.001}},
            }
