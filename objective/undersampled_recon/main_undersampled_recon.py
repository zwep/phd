...
if local_system:
    ...
    model_path = "/data/seb/code/pytorch_in_mri/config_template"
...
if __name__ == '__main__':
    ...
    for full_model_path in model_path_list:
        ...
        decision_obj = executor.DecisionMakerRecon(model_path=full_model_path, debug=debug_ind, index_gpu=index_gpu)  # ==>>
        ...
        #modelrun_obj.store_test_predictions()
        plt.close('all')
