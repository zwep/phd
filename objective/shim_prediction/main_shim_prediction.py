...
config_file_name = "shim_prediction.json"  # ==>>
...
if __name__ == '__main__':
    ...
    if local_system:
        config_model['dir']['ddata'] = "/media/bugger/MyBook/data/7T_data/b1_shim_series_resize_dataset"
    ...
    for full_model_path in model_path_list:
        ...
        decision_obj = executor.DecisionMakerShimPredicton(model_path=full_model_path, debug=debug_ind, index_gpu=index_gpu)  # ==>>
