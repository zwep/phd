...
if os.path.isfile(__file__):
    ...
    if getpass.getuser() == 'bugger':
        dest_path = '/home/bugger/PycharmProjects/pytorch_in_mri/objective/shim_prediction'
    else:
        dest_path = '/home/seb/code/pytorch_in_mri/objective/shim_prediction'
...
target_name = "shim_prediction.json"  # ==>


template = {"name": "shim_prediction",
            "packed_keys": [
                            ],
            "dir": {"ddata":  "/data/seb/shimseries_resize"},
            "model": {"model_choice": "piennet",
