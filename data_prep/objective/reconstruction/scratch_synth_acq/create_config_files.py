...
from objective_configuration.reconstruction import DMODEL, DPRETRAINED, ANATOMY_LIST, \
    PERCENTAGE_LIST, DDATA, NUM_ITERATIONS_PARALLEL, SCRATCH_SYNTH_ACQ_APPENDIX
...
if __name__ == "__main__":
    ...
    dest_path = os.path.join(DMODEL, path + SCRATCH_SYNTH_ACQ_APPENDIX, 'config')
    ...
    for i_percentage in PERCENTAGE_LIST:
        ...
        DIRECT_update_config_dict(temp_yaml, ddata=DDATA, anatomical_region=i_anatomy, percentage=i_percentage,
