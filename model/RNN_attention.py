...
from model.Attention import AttentionModule_stage1, AttentionModule_stage2, AttentionModule_stage3, AttentionModule_stage0
from model.Attention import AttentionModule_stage1_cifar, AttentionModule_stage2_cifar, AttentionModule_stage3_cifar
...
if __name__ == "__main__":
    import numpy as np
    # Lets see how much plug-n-play this is
    model_obj = ResidualAttentionModel_56()
    A = np.random.rand(10, 3, 32, 32)
