...
python data_prep/objective/reconstruction/pretr_acq/create_config_files.py -path $model_name
./papers/reconstruction/DIRECT/pretr_acq/train.sh -m $model_name -p 100
