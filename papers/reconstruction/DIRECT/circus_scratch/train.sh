...
for anatomy in 'mixed'; do
  ...
  name="${name}_${anatomy}"
  config_path="${MODEL_RUN}/${model_name}_CIRCUS_SCRATCH/config/config_${percentage}p_${anatomy}.yaml"
  output_path="${MODEL_RUN}/${model_name}_CIRCUS_SCRATCH/${percentage}p"
