...
if [[ $username == "sharreve" ]]; then
    ...
    DINFERENCE="${HOME}/mri_data/cardiac_radial_inference/input"
    # Not sure if this is the correct location \/
    DRESULT="${HOME}/paper/reconstruction/inference"
elif [[ $username == "20184098" ]]; then
    MODEL_RUN="${HOME}/model_run/direct"
    DINFERENCE="${HOME}/data/direct_inference"
